...
export default function IstanbulSehirSayfasi() {
  const data = sehirData[sehir];
  if (!data) notFound();
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        "Konut kamera sistemi 12.000 TL'den, işyeri sistemleri 15.000 TL'den başlar. Keşif sonrası net fiyat oluşur.",
    },
    {
  ...
  return (
    <>
        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <p className="text-white/80 text-lg mb-8 leading-relaxed">
              {data.name} ve çevresinde profesyonel güvenlik sistemi kurulumu.
              Ücretsiz keşif + anahtar teslim montaj.
            </p>
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="grid grid-cols-1 gap-4">
              {[
                {
                  label: `${data.name}'de Tamamlanan Proje`,
      ...
      <FAQSection
        items={faqItems}
        title={`${data.name} Hakkında Sık Sorulan Sorular`}
      />
