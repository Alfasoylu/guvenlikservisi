  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-white border-t border-gray-200 px-4 py-3 flex gap-3 shadow-xl">
        ...
        <a
          href={`https://wa.me/${siteConfig.whatsapp}?text=${encodeURIComponent("Merhaba, teklif almak istiyorum.")}`}
          target="_blank"
      ...
      {/* Mobil sticky bar yüksekliği kadar boşluk */}
